...
import 'package:tamil_theni_quiz_api/client.dart';
import 'package:http/http.dart' as http;

/// {@template tamil_theni_quiz_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class TamilTheniQuizApiMalformedResponse implements Exception {
  /// {@macro tamil_theni_quiz_api_malformed_response}
  const TamilTheniQuizApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template tamil_theni_quiz_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class TamilTheniQuizApiRequestFailure implements Exception {
  /// {@macro tamil_theni_quiz_api_request_failure}
  const TamilTheniQuizApiRequestFailure({
...
/// {@template tamil_theni_quiz_api_client}
/// A Dart API client for the Tamil Theni Quiz API.
/// {@endtemplate}
class TamilTheniQuizApiClient {
  /// Create an instance of [TamilTheniQuizApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro tamil_theni_quiz_api_client}
  TamilTheniQuizApiClient({
  ...
  ///
  /// {@macro tamil_theni_quiz_api_client}
  TamilTheniQuizApiClient.localhost({
    required TokenProvider tokenProvider,
    http.Client? httpClient,
  }) : this._(
  ...
  Future<ArticleResponse> getArticle({
    ...
    if (response.statusCode != HttpStatus.ok) {
      throw TamilTheniQuizApiRequestFailure(
        body: body,
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        TamilTheniQuizApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
