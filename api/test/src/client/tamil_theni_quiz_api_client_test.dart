...
void main() {
  ...
  group('TamilTheniQuizApiClient', () {
    late http.Client httpClient;
    late TamilTheniQuizApiClient apiClient;
    ...
    setUp(() {
      ...
      apiClient = TamilTheniQuizApiClient(
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = TamilTheniQuizApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => TamilTheniQuizApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = TamilTheniQuizApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws TamilTheniQuizApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<TamilTheniQuizApiMalformedResponse>()),
        );
      });

      test(
          'throws TamilTheniQuizApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<TamilTheniQuizApiRequestFailure>()
