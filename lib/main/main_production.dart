...
import 'package:tamil_theni_quiz/main/bootstrap/bootstrap.dart';
import 'package:tamil_theni_quiz/src/version.dart';
  ...
  bootstrap(
    (
      ...
      final packageInfoClient = PackageInfoClient(
        appName: 'Tamil Theni Quiz [DEV]',
        packageName: 'org.tamiltheni.quiz.app.dev',
